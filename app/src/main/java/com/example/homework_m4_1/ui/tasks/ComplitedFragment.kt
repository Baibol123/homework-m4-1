...
import com.example.homework_m4_1.databinding.FragmentComplitedBinding


class ComplitedFragment(
    private val tasks: ArrayList<ListTasks>,
    private val onItemClick: (position: Int) -> Unit
) : Fragment() {
    private var _binding: FragmentComplitedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentComplitedBinding.inflate(inflater, container, false)
        return binding.root
    }
